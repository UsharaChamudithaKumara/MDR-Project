...
import { Form, Input, Select, DatePicker, Button, Radio, Upload, message, Typography, Space, AutoComplete, Steps } from "antd";
    ...
    const fetchMDR = async () => {
      try {
        ...
        form.setFieldsValue({
          ...
          corrective_action: header.corrective_action,
